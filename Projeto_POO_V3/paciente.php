...
class Paciente extends Pessoa implements  Iparticular , Iplano  
{
  ...
  public function __construct($nome, $idade, $dataNascimento,$email,$senha,$cartaoclinica, $tipo_atendimento, $endereco,$telefone,$tipo_consulta)
  {
    $this->nome = $nome;
    $this->idade = $idade;
...
$objpaciente1 = new Paciente("Nicolas", "22", "12/11/1998","nicolas@gmail.com","123456",123456789, "emergência","Rua do Arame, 470, Salgadinho , Olinda","985467801","Plano");
...
echo "<br>";
echo "<hr>";
$objpaciente2 = new Paciente("Myllena", "26", "05/09/1995","myllena@outlook.com","135079",987654321,"urgencia","Rua do teste, 840, Piedade , Recife","997463781","Particular");
